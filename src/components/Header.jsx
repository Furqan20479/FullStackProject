      ...
      <header className="w-full h-auto bg-blue-600 flex justify-between" >
        ...
        <nav className="w-1/2 ">
          <ul className="h-auto w-full flex justify-evenly">
            ...
            <li>
              <Link to="/" className="text-[20px] text-white">Home</Link>
            </li>

            <li>
              <Link to="/shop" className="text-[20px] text-white">Shop</Link>
            </li>

            <li>
              <Link to="/collection" className="text-[20px] text-white">Collection</Link>
            </li>

            <li>
              <Link to="/cart" className="text-[20px] text-white">Cart</Link>
            </li>
